...
public class Ekit_Unit_Tests {
  ...
  @Test
  public void shouldRejectAnchorIfNoTextIsSelected()
  ...
  public void shouldExtractExistingLink() throws InterruptedException {
    ...
    // window.textBox("main").setText("word1 <a href=\"" + OLD_URL +
    // "\">link</a> word2");
  ...
  private void checkAttribute(SimpleAttributeSet sas, final String expected,
    ...
    assertEquals(expected,
      ((SimpleAttributeSet) sas.getAttribute(key1)).getAttribute(key2));
  }
